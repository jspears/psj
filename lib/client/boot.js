require(['jquery','underscore', 'backbone', 'psj/lib/client/psj-remote-resolver', 'psj/lib/client/psj-parsed-functions-remote'], function ($, _, B, resolver, ctxMap) {

    require(['psj/lib/psj-context'], function (Context) {
        ...
        app_router.on('route:defaultRoute', function (actions) {
            ...
            if (cache[actions]) {
                ...
                require(['text!jsp/' + actions], function (content) {
