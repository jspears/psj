...
Tag.prototype._create = function (str) {
    ...
    return function validator(obj, parent, current, info) {
        obj = obj || {};
        ...
        return function execute(currentPageContext) {
            ...
            _.extend(currentPageContext.scope.tagScope, current && current.scope && current.scope.tagScope);
