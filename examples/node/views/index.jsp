...
<%@taglib prefix="funky" tagdir="/functions/string"%>
    ...
    <!-- Bootstrap -->
    <link href="jam/bootstrap/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen">
    <link href="jam/bootstrap/bootstrap/css/bootstrap-responsive.css" rel="stylesheet">
    <link href="node/public/css/style.css" rel="stylesheet">
    </head>
    <body>
